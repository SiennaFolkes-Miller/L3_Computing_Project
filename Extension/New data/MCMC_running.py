...
run_supernova_mcmc(z, mu, sigma_mu, Omega_L_init = 0.7, Omega_k_init = 0.0, H0_init = 70.0, prior_type="cmb_directional", flat_universe=True, fix_H0=True, H0_fixed = 70.0, nwalkers=50, nsteps=2000,discard=400,thin=1,output=True)
...
run_supernova_mcmc(z, mu, sigma_mu, Omega_L_init = 0.7, Omega_k_init = 0.0, H0_init = 70.0, prior_type="cmb_directional", flat_universe=True, fix_H0=False, H0_fixed = 70.0, nwalkers=75, nsteps=3000,discard=600,thin=1,output=True)
...
run_supernova_mcmc(z, mu, sigma_mu, Omega_L_init = 0.7, Omega_k_init = 0.0, H0_init = 70.0, prior_type="cmb_directional", flat_universe=False, fix_H0=False, H0_fixed = 70.0, nwalkers=100, nsteps=5000,discard=1000,thin=1,output=True)
